...
class Chapter5SolutionsTest extends AnyFlatSpec with should.Matchers {
  implicit def enrichStringContext(sc: StringContext): RichStringContext =
    new RichStringContext(sc)
  ...
  "insert" should "insert the integer into the other" in {
    ...
    Chapter5Solutions.insert(
      b"101000000000",
      b"1101",
      4,
      2
    ) shouldBe b"101000110100"
    Chapter5Solutions.insert(
      ~0,
      b"1101",
      4,
      2
    ) shouldBe ~0 ^ (b"1111" << 2) | (b"1101" << 2)
  ...
  "floatToBinaryString" should "convert a double to a string" in {
    ...
    Chapter5Solutions.floatToBinaryString(
      b"10101010".toDouble / Math.pow(2, 8)
    ) shouldBe ".1010101"
  }
  ...
  "flipBitToWin" should "find the longest sequence possible with one flip" in {
    ...
    Chapter5Solutions.flipBitToWin(
  ...
  "nextNumber" should "find the next smaller and next larger integers with the same number of 1s in the binary representation" in {
    Chapter5Solutions.nextNumber(b"10") shouldBe new NextNumberResult(
      b"1",
      b"100"
    )
    Chapter5Solutions.nextNumber(b"110") shouldBe new NextNumberResult(
      b"101",
      b"1001"
    )
    Chapter5Solutions.nextNumber(
      b"01010000000000000000000000000000"
    ) shouldBe new NextNumberResult(
      b"01001000000000000000000000000000",
    ...
    Chapter5Solutions.nextNumber(b"11") shouldBe new NextNumberResult(
      -1,
      b"101"
    )
  }
  ...
  "pairwiseSwap" should "swap all the bits in an integer with the neighboring bits" in {
    ...
    Chapter5Solutions.pairwiseSwap(
      b"1010101010101010101010101010101010101010101010101010101010101010"
    ) shouldBe b"0101010101010101010101010101010101010101010101010101010101010101"
    Chapter5Solutions.pairwiseSwap(
      b"0101010101010101010101010101010101010101010101010101010101010101"
    ) shouldBe b"1010101010101010101010101010101010101010101010101010101010101010"
    Chapter5Solutions.pairwiseSwap(
      b"1111111111111111111111111111111100000000000000000000000000000000"
    ) shouldBe b"1111111111111111111111111111111100000000000000000000000000000000"
    Chapter5Solutions.pairwiseSwap(
      b"0000000000000000000000000000000011111111111111111111111111111111"
    ) shouldBe b"0000000000000000000000000000000011111111111111111111111111111111"
  }

  "drawLine" should "draw a line in the screen" in {
    Chapter5Solutions.drawLine(new Array(2), 8, 0, 8, 0) shouldBe Array[Byte](
      0xff.toByte,
      0
    )
    Chapter5Solutions.drawLine(new Array(2), 8, 0, 8, 1) shouldBe Array[Byte](
      0,
      0xff.toByte
    )
    Chapter5Solutions.drawLine(new Array(2), 8, 2, 6, 1) shouldBe Array[Byte](
      0,
      b"00111100".toByte
    )
    Chapter5Solutions.drawLine(new Array(4), 16, 1, 6, 1) shouldBe Array[Byte](
      0,
      0,
      b"01111100".toByte,
      0
    )
    Chapter5Solutions.drawLine(new Array(8), 32, 1, 31, 1) shouldBe Array[Byte](
      0,
      0,
      0,
      0,
